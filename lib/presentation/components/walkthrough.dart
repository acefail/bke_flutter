...
class WalkThroughComponentOne extends StatelessWidget {
  @override
          ...
          child: Stack(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    Image.asset('images/recipe/walkThroughImages/imageTwo.jpg',
...
class WalkThroughComponentTwo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
...
class WalkThroughComponentThree extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
